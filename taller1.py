...
# Comprobamos si el promedio es mayor o igual que 3.0
if promedio >= 3.0:
    print("Aprobado")
else:
    print("Reprobado")
...
if color1 == 1 and color2 == 2 or color1 == 2 and color2 == 1:
    ...
    print("Combinación: Gris rojizo")
elif color1 == 4 and color2 == 5 or color1 == 5 and color2 == 4:
    print("Combinación: Gris")

# Comprobamos si los colores escogidos no generan otra combinación
elif color1 == color2:
